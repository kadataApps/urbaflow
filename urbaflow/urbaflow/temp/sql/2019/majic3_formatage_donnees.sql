...
INSERT INTO parcelle (
  parcelle, annee, ccodep, ccodir, ccocom, ccopre, ccosec, dnupla, dcntpa,
  dsrpar, dnupro, jdatat, dreflf, gpdl, cprsecr, ccosecr, dnuplar, dnupdl,
  gurbpa, dparpi, ccoarp, gparnf, gparbat, parrev, gpardp, fviti, dnvoiri,
  dindic, ccovoi, ccoriv, ccocif, ccpper, gpafpd, ajoutcoherence,
  comptecommunal, pdl, voie, cconvo, dvoilib, ccocomm, ccoprem, ccosecm,
  dnuplam, parcellefiliation, type_filiation, ccoifp, inspireid, lot
)
SELECT
...
-- Traitement: suf
INSERT INTO suf (
  suf, annee,ccodep, ccodir, ccocom, ccopre, ccosec, dnupla, ccosub, dcntsf,
  dnupro, gnexps, drcsub, drcsuba, ccostn, cgrnum, dsgrpf, dclssf, cnatsp,
  drgpos, ccoprel, ccosecl, dnuplal, dnupdl, dnulot, rclsi, gnidom, topja,
  datja, postel, ccortar, parcelle, comptecommunal, pdl, lot
)
SELECT
...
INSERT INTO sufexoneration (
  sufexoneration, annee, ccodep, ccodir, ccocom, ccopre, ccosec, dnupla,
  ccosub, rnuexn, ccolloc, pexn, gnexts, jandeb, jfinex, fcexn, fcexna, rcexna,
...
INSERT INTO suftaxation (
  suftaxation, annee,ccodep, ccodir, ccocom, ccopre, ccosec, dnupla, ccosub,
  c1majposa, c1bisufad, c2majposa, c2bisufad, c3majposa, c3bisufad, c4majposa,
  c4bisufad, cntmajtc, suf, lot
)
SELECT
...
-- Traitement: local00
INSERT INTO local00 (
  local00, annee, ccodep, ccodir, ccocom, invar, ccopre, ccosec, dnupla,
  dnubat, descr, dniv, dpor, ccoriv, ccovoi, dnvoiri, dindic, ccocif, dvoilib,
  cleinvar, ccpper, locinc, parcelle, voie, lot
)
SELECT
...
-- Traitement: local10
INSERT INTO local10 (
  local10, annee,ccodep, ccodir, ccocom, invar, gpdl, dsrpar, dnupro, jdatat,
  dnufnl, ccoeva, ccitlv, dteloc, gtauom, dcomrd, ccoplc, cconlc, dvltrt,
  ccoape, cc48lc, dloy48a, top48a, dnatlc, dnupas, gnexcf, dtaucf, cchpr,
  jannat, dnbniv, hlmsem, postel, dnatcg, jdatcgl, dnutbx, dvltla, janloc,
  ccsloc, fburx, gimtom, cbtabt, jdtabt, jrtabt, jacloc, cconac, toprev, ccoifp,
  comptecommunal, lot
)
SELECT
...
CREATE INDEX idx_local10_invar ON local10 (invar);
CREATE INDEX idx_local00_invar ON local00 (invar);

UPDATE local10 SET
  dnubat = local00.dnubat,
  ...
  parcelle = REPLACE(
    local10.ccodep || local10.ccodir || local10.ccocom || local00.ccopre || local00.ccosec || local00.dnupla,
    ' ',
    '0'
  ),

  voie= REPLACE(
    local10.ccodep || local10.ccodir || local10.ccocom || local00.ccovoi || local00.ccoriv,
    ' ',
    '0'
  )

FROM local00
WHERE local00.ccodep = local10.ccodep
  AND local00.ccodir = local10.ccodir
  AND local00.invar = local10.invar
  AND local00.annee='2019'
  AND local10.annee='2019';
...
INSERT INTO pevexoneration (
  pevexoneration, annee,ccodep, ccodir, ccocom, invar, Janbil, dnupev, dnuexb,
  ccolloc, pexb, gnextl, jandeb, janimp, vecdif, vecdifa, fcexb, fcexba, rcexba,
  dvldif2, dvldif2a, fcexb2, fcexba2, rcexba2, valplaf, pev, lot
)
SELECT
...
INSERT INTO pevexoneration_imposable
(
...
INSERT INTO pevexoneration_imposee (
  pevexoneration_imposee, annee,ccodep, ccodir, ccocom, invar, Janbil, dnupev,
  dnuexb, ccolloc, pexb, gnextl, jandeb, janimp, vecdif, vecdifa, fcexb, fcexba,
  rcexba, dvldif2, dvldif2a, fcexb2, fcexba2, rcexba2, valplaf, pev, lot
)
SELECT
...
INSERT INTO pevprincipale (
  pevprincipale, annee,ccodep, ccodir, ccocom, invar, dnupev, dnudes,
  dep1_cconad, dep1_dsueic, dep1_dcimei, dep2_cconad, dep2_dsueic, dep2_dcimei,
  dep3_cconad, dep3_dsueic, dep3_dcimei, dep4_cconad, dep4_dsueic, dep4_dcimei,
  geaulc, gelelc, gesclc, ggazlc, gasclc, gchclc, gvorlc, gteglc, dnbbai,
  dnbdou, dnblav, dnbwc, deqdha, dnbppr, dnbsam, dnbcha, dnbcu8, dnbcu9, dnbsea,
  dnbann, dnbpdc, dsupdc, dmatgm, dmatto, jannat, detent, dnbniv, pev, lot
)
SELECT
...
INSERT INTO pevprofessionnelle (
  pevprofessionnelle, annee, ccodep, ccodir,
  ccocom, invar, dnupev, dsupot, dsup1, dsup2, dsup3, dsupk1, dsupk2, pev,
  lot
)
SELECT
  ...
  '' AS lot
FROM bati
WHERE SUBSTRING(tmp,31,2) ='50';

-- Traitement:
INSERT INTO pevlissage (
  pevlissage, annee, ccodep, ccodir, ccocom, invar,
  dnupev, mlbcom, mlbsyn, mlbcu , mlbdep, mlbts1, mlbts2, mlbtas, mlbgem,
  mlbtom, tbfpas, mlbtfc, pev, lot
)
SELECT DISTINCT
...
FROM bati
WHERE SUBSTRING(tmp,31,2) ='52';

-- Traitement: pevdependances
INSERT INTO pevdependances (
  pevdependances, annee, ccodep, ccodir, ccocom, invar, dnupev, dnudes, dsudep,
...
INSERT INTO proprietaire (
  proprietaire, annee, ccodep, ccodir, ccocom, dnupro, dnulp, ccocif, dnuper,
  ccodro, ccodem, gdesip, gtoper, ccoqua, dnatpr, ccogrm, dsglpm, dforme,
  ddenom, gtyp3, gtyp4, gtyp5, gtyp6, dlign3, dlign4, dlign5, dlign6, ccopay,
  ccodep1a2, ccodira, ccocom_adr, ccovoi, ccoriv, dnvoiri, dindic, ccopos,
  dqualp, dnomlp, dprnlp, jdatnss, dldnss, epxnee, dnomcp, dprncp, dsiren,
  topja, datja, dformjur, dnomus, dprnus, comptecommunal, lot
)
...
SELECT
  ...
  '' as lot
FROM proprietaire
WHERE annee='2019' AND lot=''
GROUP BY ccodep, ccodir, ccocom, dnupro;

-- Traitement: pdl
INSERT INTO pdl (
  pdl, annee, ccodep, ccodir, ccocom, ccopre, ccosec, dnupla, dnupdl, dnivim,
  ctpdl, dmrpdl, gprmut, dnupro, ccocif, parcelle, comptecommunal, lot
)
SELECT
...
INSERT INTO parcellecomposante
(
...
-- Traitement: lots
INSERT INTO lots (
  lots, annee, ccodep, ccodir, ccocom, ccopre, ccosec, dnupla, dnupdl, dnulot,
  cconlo, dcntlo, dnumql, ddenql, dfilot, datact, dnuprol, dreflf, ccocif, pdl,
  comptecommunal, parcelle, lot
)
SELECT
...
INSERT INTO lotslocaux (
  lotslocaux, annee, ccodepl, ccodirl, ccocoml, ccoprel, ccosecl, dnuplal,
  dnupdl, dnulot, ccodebpb, ccodird, ccocomb, ccopreb, invloc, dnumql, ddenql,
...
ANALYZE parcelle;
ANALYZE suf;
ANALYZE sufexoneration;
ANALYZE suftaxation;
ANALYZE local00;
ANALYZE local10;
ANALYZE pev;
ANALYZE pevexoneration_imposable;
ANALYZE pevexoneration_imposee;
ANALYZE pevtaxation;
ANALYZE pevprincipale;
ANALYZE pevprofessionnelle;
ANALYZE pevdependances;
ANALYZE proprietaire;
ANALYZE comptecommunal;
ANALYZE pdl;
ANALYZE parcellecomposante;
ANALYZE lots;
ANALYZE lotslocaux;
-- ANALYZE commune;
-- ANALYZE voie;
