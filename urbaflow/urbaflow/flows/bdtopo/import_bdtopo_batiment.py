...
# Identifiant de la ressource BD TOPO sur la Géoplateforme et format de livraison
GEOPF_RESOURCE_ID = "BDTOPO"
...
@task
def download_and_extract_geopackage(resource: GeopfResource) -> Path:
    """
